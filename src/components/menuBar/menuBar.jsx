    ...
    >
      ...
      <Drawer
        ...
        sx={{
          ...
          "& .MuiDrawer-root": { width:'65%',bgcolor:'#222',position: "absolute", top: "60px" },
          "& .MuiDrawer-paper": { width:'65%',bgcolor:'#222',position: "absolute", top: "60px" },
        }}
        open={open}
      ...
      >
        ...
        >
          <img
            ...
            alt="Marc logo"
          />
          <Typography sx={{ml:'15px', fontWeight:'bold'}} variant="body1" color="#f0f0f0">
            Marc RAMADISON
          </Typography>
        </Box>
        <Box
